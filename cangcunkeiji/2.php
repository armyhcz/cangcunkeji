...
<head>
    ...
    <title>侯成泽</title>
        ...
        <!--  ajax showHint()函数外部genthint.php -->
...
<div class="row-fluid shop_header" id="shop_header">
        ...
        <div class="span7 shop_header_right">
            <ul class="db-nav">
                ...
                <li class="item split"></li>
                <li class="item"><a href="login.php?action=logout">注销</a></li>
                <li class="item split"></li>
            </ul>
        </div>
    </div>
...
<div class="row-fluid">
    ...
    <form method="get" class="form-search" action="search">
        <div class="input-append span12">
            <input type="text" class="search-query span9" name="keywords" value="" onkeyup="showHint(this.value)" placeholder="搜索">  <button type="submit"    class="btn">商品搜索</button>
